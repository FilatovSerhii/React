...
class UserForm extends Component {
  ...
  setRef = node => {// функция колбэк принимает домэлимент
    // this.setState({formRef: node})
    
    this.formRef = node;//сохраняем как свойство класса нашей формы, мы не сохраняем это в стэйт иначе мы получим зацикливание
  }
