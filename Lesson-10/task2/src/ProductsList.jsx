/* В файле src/ProductsList.jsx, опишите компоненту, которая принимает массив товаров в свойстве cartItems 
([{ id: '2', name: 'iPad Pro', price: 799 }, ...]) и отображает список товаров и total под ним.
*/
